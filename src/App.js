...
function App() {
      ...
      <section className='relative max-w-screen-2xl flex flex-col md:flex-row justify-between items-center min-h-[700px] px-4 py-8 sm:px-6 sm:py-12 lg:px-8'>
        ...
        <div class="flex justify-between items-center flex-col xl:flex-row relative z-1 w-full">
          ...
          <div class="flex flex-1 flex-col sm:text-center py-12 lg:items-start">
            <h1 class="text-black-800 mb-8 text-4xl font-bold font-sans sm:text-5xl md:mb-12 md:text-7xl md:text-start tracking-wide">Lorem ipsum doloret sit amet</h1>
            
            <p class="mb-8 leading-relaxed text-gray-500 md:mb-12 lg:w-4/5 xl:text-lg md:text-start">This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random.</p>
          ...
          <div className='flex flex-wrap items-center gap-4 sm:gap-0 text-black flex-1'>
            ...
            <div class="w-full rounded-lg bg-gray-400 flex flex-col p-6 bg-opacity-50 shadow-xl sm:w-1/2 sm:p-8">
                ...
                <h3 class="text-2xl font-semibold text-black sm:text-3xl">Pro Bundle</h3>
                <svg version="1.0" className='w-10 my-4' id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xmlSpace="preserve" fill="#000000" stroke="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path fill="#3d3d3d" d="M60,52H4c-2.211,0-4,1.789-4,4s1.789,4,4,4h56c2.211,0,4-1.789,4-4S62.211,52,60,52z"></path> <path fill="#3d3d3d" d="M60,8c0-2.211-1.789-4-4-4H8C5.789,4,4,5.789,4,8v40h56V8z"></path> </g> </g></svg>
                <p class="text-gray-700">This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. </p>
              </div>
        ...
        <form class="flex w-full my-4 gap-2 md:max-w-md">
                  <input placeholder="Email" class="w-full flex-1 rounded border bg-gray-50 px-1 py-2 text-gray-800 placeholder-gray-500 outline-none ring-[#19FFBD3] transition duration-100 focus:ring" />
                  <button class="inline-block rounded bg-[#19FFBD] px-2 py-2 text-center text-sm font-semibold text-black outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Sign up</button>
                </form>
            ...
            <div class="rounded-lg flex flex-col bg-gray-300 bg-opacity-50 p-6 sm:w-1/2 sm:rounded-l-none sm:p-8">
                ...
                <svg version="1.0" className='w-10 my-6' id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xmlSpace="preserve" fill="#000000" stroke="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path fill="#3d3d3d" d="M60,52H4c-2.211,0-4,1.789-4,4s1.789,4,4,4h56c2.211,0,4-1.789,4-4S62.211,52,60,52z"></path> <path fill="#3d3d3d" d="M60,8c0-2.211-1.789-4-4-4H8C5.789,4,4,5.789,4,8v40h56V8z"></path> </g> </g></svg>
                <p class="text-black">This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. </p>
                <form class="flex w-full my-4 gap-2 md:max-w-md">
                  <input placeholder="Email" class="w-full flex-1 rounded border bg-gray-50 px-1 py-2 text-gray-800 placeholder-gray-500 outline-none ring-[#19FFBD] transition duration-100 focus:ring" />
                  <button class="inline-block rounded bg-[#19FFBD] px-2 py-2 text-center text-sm font-semibold text-black outline-none ring-[#19FFBD] transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Sign up</button>
                </form>
            </div>
  ...
  />
                ...
                <p class="text-gray-700">This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. </p>
                <a href='#' className='w-full rounded bg-[#19FFBD] px-8 py-2 text-center text-sm font-semibold text-black outline-none text-center mt-4'>See More</a>
              </div>
      ...
      <section className='max-screen-md mx-auto my-[10rem] min-h-screen'>
        ...
        <h1 class="text-black-800 mb-8 text-4xl font-bold font-sans sm:text-5xl md:mb-12 md:text-6xl tracking-wider">Lorem ipsum doloret sit amet</h1>
        <p class="mb-8 max-w-4xl text-gray-500 lg:text-lg text-center">This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random.</p>
        </div>
        ...
        <div class="grid place-items-center mx-12 gap-x-2 gap-y-6 sm:grid-cols-1 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-3 relative">
          ...
          <div className='flex flex-col gap-12'>
            ...
            <div className='grid justify-items-end gap-4 text-end border-2 border-gray-100 shadow-lg p-4'>
              <div className='w-24 h-24 flex justify-center items-center bg-[#19FFBD] rounded-lg text-3xl'>1</div>
              <h5 className='text-3xl'>Lorem ipsum</h5>
              <p>This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. </p>
            </div>
          ...
          <div className='flex flex-col gap-12'>
            ...
            <div className='grid justify-items-start gap-4 text-start border-2 border-gray-100 shadow-lg p-4'>
              <div className='w-24 h-24 flex justify-center items-center bg-[#19FFBD] rounded-lg text-3xl'>1</div>
              <h5 className='text-3xl'>Lorem ipsum</h5>
              <p>This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. </p>
            </div>
      ...
      <section className='max-w-6xl  mx-auto my-[10rem]'>
        <div className='rounded-lg bg-white shadow-2xl flex justify-center items-center p-6 relative z-1'>
          ...
          <div className='flex flex-col gap-4'>
            <h3 class="text-2xl font-semibold text-black sm:text-5xl">Something about the app</h3>
            <p class="mb-8 max-w-4xl text-gray-500 lg:text-lg text-start">This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random.</p>
          ...
          <div className='absolute z-1 w-full bottom-0'>
            <svg className='rounded-b-lg object-contain' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
              <path fill="#19FFBD" fill-opacity="1" d="M0,32L48,37.3C96,43,192,53,288,101.3C384,149,480,235,576,240C672,245,768,171,864,133.3C960,96,1056,96,1152,122.7C1248,149,1344,203,1392,229.3L1440,256L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
            </svg>
          </div>
      ...
      <section className='max-w-screen-2xl flex justify-center items-center mx-auto h-screen relative'>
        ...
        <div className='flex flex-col justify-center items-center gap-4'>
          <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-7xl text-black">We invest in the world’s potential</h1>
          <p class="mb-8 max-w-4xl text-gray-500 lg:text-lg text-center">This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random.</p>
          <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-700 rounded-lg bg-[#19FFBD] hover:bg-[#19FFBD] focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Learn more
                <svg class="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </a>
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-gray-700 dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
      ...
      <section className='max-w-5xl  mx-auto my-[10rem]'>
        <div className='rounded-lg bg-[#19FFBD] shadow-2xl flex justify-between items-center p-6 relative z-1'>
          ...
          <div className='absolute bottom-0 z-0 w-full'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FFFFFF " fill-opacity="1" d="M0,224L34.3,208C68.6,192,137,160,206,165.3C274.3,171,343,213,411,208C480,203,549,149,617,149.3C685.7,149,754,203,823,202.7C891.4,203,960,149,1029,112C1097.1,75,1166,53,1234,37.3C1302.9,21,1371,11,1406,5.3L1440,0L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path></svg>
          </div>

          <div className='relative z-1 flex flex-col gap-12'>
            <h4 class="text-2xl font-semibold sm:text-3xl text-gray-700">Lorem ipsum doloret sit amet</h4>
            <button class="w-1/2 inline-block rounded bg-gray-700 px-8 py-2 text-center text-sm font-semibold text-white outline-none ring-gray-700 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Download now</button>
          </div>
            ...
            <div className="max-w-screen-xl mx-auto px-4 md:px-6">
                <div className="grid gap-4 md:grid-cols-2 lg:gap-10">
                    <div className="md:pt-8">
                        ...
                        <p className="mb-6 text-gray-500 sm:text-lg md:mb-8">While the collection in the Galleria Corsini is still organized and displayed in keeping with the 18th century inventory, at Palazzo Barberini the display follows the development of the principal Italian schools of painting from the 1200s to the 1700s. Unlike the historical display in the Galleria Corsini, at Palazzo Barberini the museum installation may be supplemented by new acquisitions or reorganized according to different criteria.
</p>

                        <p className="mb-6 text-gray-500 sm:text-lg md:mb-2">Over the years, the national collection on display in Palazzo Corsini had expanded through acquisitions and donations, like the collections of the Torlonia family and the Monte di Pietà in 1892, the bequest of Henriette Hertz in 1915 and the acquisition of the Chigi family collection in 1918. The growth of the collection made it necessary to find a new exhibition venue, and the choice fell on Palazzo Barberini.</p>
                    </div>
...
<p className="mb-6 text-gray-500 sm:text-lg md:mb-8">While the collection in the Galleria Corsini is still organized and displayed in keeping with the 18th century inventory, at Palazzo Barberini the display follows the development of the principal Italian schools of painting from the 1200s to the 1700s. Unlike the historical display in the Galleria Corsini, at Palazzo Barberini the museum installation may be supplemented by new acquisitions or reorganized according to different criteria.
        ...
        <div className='rounded-lg bg-white shadow-2xl flex flex-col md:flex-row justify-between items-center border-2 border-gray-100 relative z-1'>
          <div class="mb-4 flex flex-col items-start justify-between gap-4 relative z-1 p-6 ">            
            ...
            <span className='block h-[0.5px] bg-gray-300 w-full my-2'></span>
            <p class="text-gray-700">This is a div of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random. </p>
            <a href='#' className='w-1/2 rounded bg-[#19FFBD] px-8 py-2 text-center text-sm font-semibold text-black outline-none text-center mt-4'>See More</a>
          </div>
    
            <img src={bg} alt='/' className='h-full w-full md:w-2/5 object-cover md:object-cover rounded-lg md:rounded-l-none md:rounded-r-lg' />
